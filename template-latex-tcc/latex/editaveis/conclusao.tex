...
No caso das LLMs, as respostas podem variar conforme o provedor, a versão do modelo, a formulação do prompt, os limites 
...
Outra possibilidade é investigar novas estratégias de prompt. Os resultados indicaram que o uso de few-shot não produziu 
...
prático no processo de manutenção de software.
